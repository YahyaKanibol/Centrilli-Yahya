Feature: Login Functionality
  ...
  @ac1tc1mnf
  Scenario Outline: Verify that user can login with valid credentials as "manufacturing user" by pressing enter key
  ...
  @ac1tc2mnf
  Scenario Outline: Verify that user can login with valid credentials as "manufacturing user" by clicking on login button
    When User goes to application page
